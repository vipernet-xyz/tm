...
import (
	...
	tmcon "github.com/vipernet-xyz/tm/consensus"
	cstypes "github.com/vipernet-xyz/tm/consensus/types"
	"github.com/vipernet-xyz/tm/crypto"
	tmevents "github.com/vipernet-xyz/tm/libs/events"
	"github.com/vipernet-xyz/tm/libs/fail"
	tmjson "github.com/vipernet-xyz/tm/libs/json"
	"github.com/vipernet-xyz/tm/libs/log"
	tmmath "github.com/vipernet-xyz/tm/libs/math"
	tmos "github.com/vipernet-xyz/tm/libs/os"
...
func (cs *State) handleMsg(mi msgInfo) {
	...
	case *tmcon.VoteMessage:
		...
		// a typical peer.
		// https://github.com/vipernet-xyz/tm/issues/1281
		// }
...
func (cs *State) tryAddVote(vote *types.Vote, peerID p2p.ID) (bool, error) {
	...
	if err != nil {
		...
		if voteErr, ok := err.(*types.ErrVoteConflictingVotes); ok {
			...
			// 		(https://github.com/vipernet-xyz/tm/issues/3839).
...
func (cs *State) voteTime() time.Time {
	...
	// even if cs.LockedBlock != nil. See https://github.com/vipernet-xyz/tm/tree/v0.34.x/spec/.
	timeIota := time.Duration(cs.state.ConsensusParams.Block.TimeIotaMs) * time.Millisecond
	if cs.LockedBlock != nil {
		// See the BFT time spec
		// https://github.com/vipernet-xyz/tm/blob/v0.34.x/spec/consensus/bft-time.md
