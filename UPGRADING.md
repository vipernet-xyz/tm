...
Note that in [\#9724](https://github.com/vipernet-xyz/tm/pull/9724) we
...
Refactor](https://github.com/vipernet-xyz/tm/blob/main/docs/architecture/adr-067-mempool-refactor.md).
...
* New ABCI methods (`ListSnapshots`, `LoadSnapshotChunk`, `OfferSnapshot`, and `ApplySnapshotChunk`)
  ...
  Read [the spec](https://github.com/vipernet-xyz/tm/blob/v0.34.x/spec/abci/apps.md#state-sync)
...
* The [`PublicKey` type](https://github.com/vipernet-xyz/tm/blob/v0.34.x/proto/tendermint/crypto/keys.proto#L13-L15)
...
* The `state` package now has a `Store` interface. All functions in
  [state/store.go](https://github.com/vipernet-xyz/tm/blob/56911ee35298191c95ef1c7d3d5ec508237aaff4/state/store.go#L42-L42)
...
```sh
go install -mod=readonly -ldflags "-X github.com/vipernet-xyz/tm/version.TMCoreSemVer=$(go list -m github.com/vipernet-xyz/tm | sed  's/ /\@/g') -s -w " -trimpath ./cmd
```
...
[here](https://github.com/vipernet-xyz/tm/pull/3668).
...
keys are called
[compositeKeys](https://github.com/vipernet-xyz/tm/blob/6d05c531f7efef6f0619155cf10ae8557dd7832f/docs/app-dev/indexing-transactions.md).
...
For further documentation on `Events`, see the [docs](https://github.com/vipernet-xyz/tm/blob/60827f75623b92eff132dc0eff5b49d2025c591e/docs/spec/abci/abci.md#events).
...
* [Merkle tree](https://github.com/vipernet-xyz/tm/blob/v0.34.x/spec/blockchain/encoding.md#merkle-trees)
* [ConsensusParams](https://github.com/vipernet-xyz/tm/blob/v0.34.x/spec/blockchain/state.md#consensusparams)

There was also a small change to field ordering in the vote struct. Any
implementations of an out-of-process validator (like a Key-Management Server)
will need to be updated. For specific details:

* [Vote](https://github.com/vipernet-xyz/tm/blob/v0.34.x/spec/consensus/signing.md#votes)

Finally, the proposer selection algorithm continues to evolve. See the
[work-in-progress
specification](https://github.com/vipernet-xyz/tm/pull/3140).
...
See [#3105](https://github.com/vipernet-xyz/tm/issues/3105).
Note the Unix socket has neither encryption nor authentication, but will
add a shared-secret in [#3099](https://github.com/vipernet-xyz/tm/issues/3099).
...
* [ADR-026](https://github.com/vipernet-xyz/tm/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/docs/architecture/adr-026-general-merkle-proof.md)
* [Relevant ABCI
  documentation](https://github.com/vipernet-xyz/tm/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/docs/spec/abci/apps.md#query-proofs)
* [Description of
  keys](https://github.com/vipernet-xyz/tm/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/crypto/merkle/proof_key_path.go#L14)
...
[here](https://github.com/vipernet-xyz/tm/blob/30519e8361c19f4bf320ef4d26288ebc621ad725/cmd/tendermint/commands/run_node.go#L60).
