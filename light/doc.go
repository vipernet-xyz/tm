...
https://github.com/vipernet-xyz/tm/blob/v0.34.x/spec/consensus/light-client/verification.md
for details.
...
for usage example.
Or see
https://github.com/vipernet-xyz/tm/tree/v0.34.x/spec/consensus/light-client
for the full spec
*/
package light
