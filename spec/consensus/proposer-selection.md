...
Curent implementation uses the penalty factor of 1.125 because it provides a small punishment that is efficient to calculate. See [here](https://github.com/vipernet-xyz/tm/pull/2785#discussion_r235038971) for more details.
