...
- To _prevote_ or _precommit_ something means to broadcast a [prevote
  vote](https://godoc.org/github.com/vipernet-xyz/tm/types#Vote)
  or [first precommit
  vote](https://godoc.org/github.com/vipernet-xyz/tm/types#FirstPrecommit)
  for something.
...
- Nodes gossip to nodes lagging in blockchain height with block
  [commits](https://godoc.org/github.com/vipernet-xyz/tm/types#Commit)
  for older blocks.
...
voting power (see
[implementation](https://github.com/vipernet-xyz/tm/blob/v0.34.x/types/validator_set.go)).
...
[commit](https://github.com/vipernet-xyz/tm/blob/v0.34.x/docs/tendermint-core/validators.md), any 1/3+ coalition of
