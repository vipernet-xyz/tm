...
Types](https://github.com/vipernet-xyz/tm/blob/v0.34.x/types/genesis.go).
...
[light client attack](https://github.com/vipernet-xyz/tm/blob/v0.34.x/spec/light-client/detection/detection_003_reviewed.md#tmbc-lc-attack1)
and not just a [bogus](https://github.com/vipernet-xyz/tm/blob/v0.34.x/spec/light-client/detection/detection_003_reviewed.md#tmbc-bogus1) block could result in
