...
[protobuf file](https://github.com/vipernet-xyz/tm/blob/v0.34.x/proto/tendermint/abci/types.proto).
...
- In-process ([Golang](https://github.com/vipernet-xyz/tm/tree/v0.34.x/abci), [Rust](https://github.com/tendermint/rust-abci))
- ABCI-socket
- GRPC
...
[Go](https://github.com/vipernet-xyz/tm/tree/v0.34.x/abci/server),
...
our client, see
[here](https://github.com/vipernet-xyz/tm/tree/v0.34.x/abci/client).
