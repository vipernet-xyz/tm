...
[default in-process ABCI client](https://github.com/vipernet-xyz/tm/blob/v0.34.4/abci/client/local_client.go#L18)
and the
[default Go ABCI
server](https://github.com/vipernet-xyz/tm/blob/v0.34.4/abci/server/socket_server.go#L32)
...
proposal. See [#1861](https://github.com/vipernet-xyz/tm/issues/1861).
