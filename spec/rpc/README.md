...
## Support
  ...
  |              | [Tendermint-Go](https://github.com/vipernet-xyz/tm/) | [endermint-Rs](https://github.com/informalsystems/tendermint-rs) |
  |--------------|:----------------------------------------------------------:|:----------------------------------------------------------------:|
  | JSON-RPC 2.0 |                             ✅                              |                                ✅                                 |
  | HTTP         |                             ✅                              |                                ✅                                 |
  | HTTPS        |                             ✅                              |                                ❌                                 |
  ...
  | Routes                                  | [Tendermint-Go](https://github.com/vipernet-xyz/tm/) | [Tendermint-Rs](https://github.com/informalsystems/tendermint-rs) |
  |-----------------------------------------|:----------------------------------------------------------:|:-----------------------------------------------------------------:|
  | [Health](#health)                       |                             ✅                              |                                 ✅                                 |
  | [Status](#status)                       |                             ✅                              |                                 ✅                                 |
  | [NetInfo](#netinfo)                     |                             ✅                              |                                 ✅                                 |
