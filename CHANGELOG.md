...
- [config] [\#9054](https://github.com/vipernet-xyz/tm/issues/9054) `discard_abci_responses` flag added to discard all ABCI
...
- Go API
  ...
  - [types] [\#4939](https://github.com/vipernet-xyz/tm/pull/4939)  `SignedMsgType` has moved to a Protobuf enum types (@marbar3778)
...
- [consensus] [\#5329](https://github.com/vipernet-xyz/tm/pull/5329) Fix wrong proposer schedule for validators returned by `InitChain` (@erikgrinaker)
...
- [privval] [\#4534](https://github.com/vipernet-xyz/tm/issues/4534) Add `error` as a return value on`GetPubKey()` (@marbar3778).
...
- [p2p] [\#4449](https://github.com/vipernet-xyz/tm/pull/4449) Use `curve25519.X25519()` instead of `ScalarMult` (@erikgrinaker)
...
- CLI/RPC/Config
  ...
  - [config] [\#4046](https://github.com/vipernet-xyz/tm/issues/4046) Rename tag(s) to CompositeKey & places where tag is still present it was renamed to event or events. Find how a compositeKey is constructed [here](https://github.com/vipernet-xyz/tm/blob/6d05c531f7efef6f0619155cf10ae8557dd7832f/docs/app-dev/indexing-transactions.md)
...
- [rpc] [\#2741](https://github.com/vipernet-xyz/tm/issues/2741) Add `proposer` to `/consensus_state` response (@princesinha19)
...
- [privval] [\#4275](https://github.com/vipernet-xyz/tm/issues/4275) Fix consensus failure when remote signer drops (@melekes)
...
- [blockchain] [\#3457](https://github.com/vipernet-xyz/tm/issues/3457)
...
Also, it contains an [ADR](https://github.com/vipernet-xyz/tm/pull/3539) that proposes decoupling the
...
- [p2p] [\#3463](https://github.com/vipernet-xyz/tm/pull/3463) Do not log "Can't add peer's address to addrbook" error for a private peer
- [p2p] [\#3547](https://github.com/vipernet-xyz/tm/pull/3547) Fix a couple of annoying typos (@mdyring)

### BUG FIXES:

- [docs] [\#3514](https://github.com/vipernet-xyz/tm/issues/3514) Fix block.Header.Time description (@melekes)
- [p2p] [\#2716](https://github.com/vipernet-xyz/tm/issues/2716) Check if we're already connected to peer right before dialing it (@melekes)
- [p2p] [\#3545](https://github.com/vipernet-xyz/tm/issues/3545) Add back `NetAddress()` to `NodeInfo` and use it instead of peer's `SocketAddr()` when adding a peer to the `PEXReactor` (potential fix for [\#3532](https://github.com/vipernet-xyz/tm/issues/3532))
- [state] [\#3438](https://github.com/vipernet-xyz/tm/pull/3438)
...
### BREAKING CHANGES:
* Go API
  - [crypto/secp256k1] [\#3439](https://github.com/vipernet-xyz/tm/issues/3439)
...
- [p2p] [\#3522](https://github.com/vipernet-xyz/tm/issues/3522) Memoize
...
* Go API
  - [libs/autofile] [\#3504](https://github.com/vipernet-xyz/tm/issues/3504) Remove unused code in autofile package. Deleted functions: `Group.Search`, `Group.FindLast`, `GroupReader.ReadLine`, `GroupReader.PushLine`, `MakeSimpleSearchFunc` (@guagualvcha)
...
- [circle] [\#3497](https://github.com/vipernet-xyz/tm/issues/3497) Move release management to CircleCI

### BUG FIXES:

- [mempool] [\#3512](https://github.com/vipernet-xyz/tm/issues/3512) Fix panic from concurrent access to txsMap, a regression for external ABCI apps introduced in v0.31.1
...
* Go API
  - [crypto] [\#3426](https://github.com/vipernet-xyz/tm/pull/3426) Remove `Ripemd160` helper method (@needkane)
  - [libs/common] [\#3429](https://github.com/vipernet-xyz/tm/pull/3429) Remove `RepeatTimer` (also `TimerMaker` and `Ticker` interface)
  - [rpc/client] [\#3458](https://github.com/vipernet-xyz/tm/issues/3458) Include `NetworkClient` interface into `Client` interface
  - [types] [\#3448](https://github.com/vipernet-xyz/tm/issues/3448) Remove method `PB2TM.ConsensusParams`
...
### FEATURES:
 ...
 - [rpc] [\#3419](https://github.com/vipernet-xyz/tm/issues/3419) Start HTTPS server if `rpc.tls_cert_file` and `rpc.tls_key_file` are provided in the config (@guagualvcha)

### IMPROVEMENTS:

- [docs] [\#3140](https://github.com/vipernet-xyz/tm/issues/3140) Formalize proposer election algorithm properties
- [docs] [\#3482](https://github.com/vipernet-xyz/tm/issues/3482) Fix broken links (@brapse)
- [mempool] [\#2778](https://github.com/vipernet-xyz/tm/issues/2778) No longer send txs back to peers who sent it to you.
...
For instance, for a 4 node localnet, in a test sending 250byte txs for 120 sec. at 500 txs/sec (total of 15MB):
  ...
  - total bytes sent to 1st node:
     ...
     - after: 19304964 (19MB)
- [p2p] [\#3475](https://github.com/vipernet-xyz/tm/issues/3475) Simplify `GetSelectionWithBias` for addressbook (@guagualvcha)
- [rpc/lib/client] [\#3430](https://github.com/vipernet-xyz/tm/issues/3430) Disable compression for HTTP client to prevent GZIP-bomb DoS attacks (@guagualvcha)

### BUG FIXES:

- [blockchain] [\#2699](https://github.com/vipernet-xyz/tm/issues/2699) Update the maxHeight when a peer is removed
- [mempool] [\#3478](https://github.com/vipernet-xyz/tm/issues/3478) Fix memory-leak related to `broadcastTxRoutine` (@HaoyangLiu)
...
See the [v0.31.0
Milestone](https://github.com/vipernet-xyz/tm/milestone/19?closed=1) for
more details.

### BREAKING CHANGES:

* CLI/RPC/Config
  - [config] [\#2920](https://github.com/vipernet-xyz/tm/issues/2920) Remove `consensus.blocktime_iota` parameter
  - [rpc] [\#3227](https://github.com/vipernet-xyz/tm/issues/3227) New PubSub design does not block on clients when publishing
    messages. Slow clients may miss messages and receive an error, terminating
    the subscription.
  - [rpc] [\#3269](https://github.com/vipernet-xyz/tm/issues/2826) Limit number of unique clientIDs with open subscriptions. Configurable via `rpc.max_subscription_clients`
  - [rpc] [\#3269](https://github.com/vipernet-xyz/tm/issues/2826) Limit number of unique queries a given client can subscribe to at once. Configurable via `rpc.max_subscriptions_per_client`.
  - [rpc] [\#3435](https://github.com/vipernet-xyz/tm/issues/3435) Default ReadTimeout and WriteTimeout changed to 10s. WriteTimeout can increased by setting `rpc.timeout_broadcast_tx_commit` in the config.
  - [rpc/client] [\#3269](https://github.com/vipernet-xyz/tm/issues/3269) Update `EventsClient` interface to reflect new pubsub/eventBus API [ADR-33](https://github.com/vipernet-xyz/tm/blob/main/docs/architecture/adr-033-pubsub.md). This includes `Subscribe`, `Unsubscribe`, and `UnsubscribeAll` methods.

* Apps
  - [abci] [\#3403](https://github.com/vipernet-xyz/tm/issues/3403) Remove `time_iota_ms` from BlockParams. This is a
    ConsensusParam but need not be exposed to the app for now.
  - [abci] [\#2920](https://github.com/vipernet-xyz/tm/issues/2920) Rename `consensus_params.block_size` to `consensus_params.block` in ABCI ConsensusParams

* Go API
  - [libs/common] TrapSignal accepts logger as a first parameter and does not block anymore
    * previously it was dumping "captured ..." msg to os.Stdout
    * TrapSignal should not be responsible for blocking thread of execution
  - [libs/db] [\#3397](https://github.com/vipernet-xyz/tm/pull/3397) Add possibility to `Close()` `Batch` to prevent memory leak when using ClevelDB. (@Stumble)
  - [types] [\#3354](https://github.com/vipernet-xyz/tm/issues/3354) Remove RoundState from EventDataRoundState
  - [rpc] [\#3435](https://github.com/vipernet-xyz/tm/issues/3435) `StartHTTPServer` / `StartHTTPAndTLSServer` now require a Config (use `rpcserver.DefaultConfig`)
...
### FEATURES:
- [config] [\#3269](https://github.com/vipernet-xyz/tm/issues/2826) New configuration values for controlling RPC subscriptions:
...
- [types] [\#2920](https://github.com/vipernet-xyz/tm/issues/2920) Add `time_iota_ms` to block's consensus parameters (not exposed to the application)
- [lite] [\#3269](https://github.com/vipernet-xyz/tm/issues/3269) Add `/unsubscribe_all` endpoint to unsubscribe from all events
- [mempool] [\#3079](https://github.com/vipernet-xyz/tm/issues/3079) Bound mempool memory usage via the `mempool.max_txs_bytes` configuration value. Set to 1GB by default. The mempool's current `txs_total_bytes` is exposed via `total_bytes` field in
  `/num_unconfirmed_txs` and `/unconfirmed_txs` RPC endpoints.

### IMPROVEMENTS:
- [all] [\#3385](https://github.com/vipernet-xyz/tm/issues/3385), [\#3386](https://github.com/vipernet-xyz/tm/issues/3386) Various linting improvements
- [crypto] [\#3371](https://github.com/vipernet-xyz/tm/issues/3371) Copy in secp256k1 package from go-ethereum instead of importing
  go-ethereum (@silasdavis)
- [deps] [\#3382](https://github.com/vipernet-xyz/tm/issues/3382) Don't pin repos without releases
- [deps] [\#3357](https://github.com/vipernet-xyz/tm/issues/3357), [\#3389](https://github.com/vipernet-xyz/tm/issues/3389), [\#3392](https://github.com/vipernet-xyz/tm/issues/3392) Update gogo/protobuf, golang/protobuf, levigo, golang.org/x/crypto
- [libs/common] [\#3238](https://github.com/vipernet-xyz/tm/issues/3238) exit with zero (0) code upon receiving SIGTERM/SIGINT
- [libs/db] [\#3378](https://github.com/vipernet-xyz/tm/issues/3378) CLevelDB#Stats now returns the following properties:
  ...
  - leveldb.alivesnaps
  - leveldb.aliveiters
- [privval] [\#3351](https://github.com/vipernet-xyz/tm/pull/3351) First part of larger refactoring that clarifies and separates concerns in the privval package.

### BUG FIXES:
- [blockchain] [\#3358](https://github.com/vipernet-xyz/tm/pull/3358) Fix timer leak in `BlockPool` (@guagualvcha)
- [cmd] [\#3408](https://github.com/vipernet-xyz/tm/issues/3408) Fix `testnet` command's panic when creating non-validator configs (using `--n` flag) (@srmo)
- [libs/db/remotedb/grpcdb] [\#3402](https://github.com/vipernet-xyz/tm/issues/3402) Close Iterator/ReverseIterator after use
- [libs/pubsub] [\#951](https://github.com/vipernet-xyz/tm/issues/951), [\#1880](https://github.com/vipernet-xyz/tm/issues/1880) Use non-blocking send when dispatching messages [ADR-33](https://github.com/vipernet-xyz/tm/blob/main/docs/architecture/adr-033-pubsub.md)
- [lite] [\#3364](https://github.com/vipernet-xyz/tm/issues/3364) Fix `/validators` and `/abci_query` proxy endpoints
  (@guagualvcha)
- [p2p/conn] [\#3347](https://github.com/vipernet-xyz/tm/issues/3347) Reject all-zero shared secrets in the Diffie-Hellman step of secret-connection
- [p2p] [\#3369](https://github.com/vipernet-xyz/tm/issues/3369) Do not panic when filter times out
- [p2p] [\#3359](https://github.com/vipernet-xyz/tm/pull/3359) Fix reconnecting report duplicate ID error due to race condition between adding peer to peerSet and starting it (@guagualvcha)
...
* [config] [\#3291](https://github.com/vipernet-xyz/tm/issues/3291) Make
  config.ResetTestRootWithChainID() create concurrency-safe test directories.

### BUG FIXES:

* [consensus] [\#3295](https://github.com/vipernet-xyz/tm/issues/3295)
  Flush WAL on stop to prevent data corruption during graceful shutdown.
* [consensus] [\#3302](https://github.com/vipernet-xyz/tm/issues/3302)
  Fix possible halt by resetting TriggeredTimeoutPrecommit before starting next height.
* [rpc] [\#3251](https://github.com/vipernet-xyz/tm/issues/3251) Fix
  `/net_info#peers#remote_ip` format. New format spec:
  * dotted decimal ("192.0.2.1"), if ip is an IPv4 or IP4-mapped IPv6 address
  * IPv6 ("2001:db8::1"), if ip is a valid IPv6 address
* [cmd] [\#3314](https://github.com/vipernet-xyz/tm/issues/3314) Return
  an error on `show_validator` when the private validator file does not exist.
* [p2p] [\#3010](https://github.com/vipernet-xyz/tm/issues/3010#issuecomment-464287627)
...
the application ([\#3285](https://github.com/vipernet-xyz/tm/issues/3285)), and even to support randomness ([\#763](https://github.com/vipernet-xyz/tm/issues/763)).
For more, see issues marked
[proposer-selection](https://github.com/vipernet-xyz/tm/labels/proposer-selection).
...
* Apps
  - [state] [\#3222](https://github.com/vipernet-xyz/tm/issues/3222)
...
* Go API
  - [types] [\#3222](https://github.com/vipernet-xyz/tm/issues/3222)
...
* Block Protocol
  - [state] [\#3286](https://github.com/vipernet-xyz/tm/issues/3286) Blocks that include already committed evidence are invalid.

* P2P Protocol
  - [consensus] [\#3222](https://github.com/vipernet-xyz/tm/issues/3222)
...
### IMPROVEMENTS:
- [crypto] [\#3279](https://github.com/vipernet-xyz/tm/issues/3279) Use `btcec.S256().N` directly instead of hard coding a copy.

### BUG FIXES:
- [state] [\#3222](https://github.com/vipernet-xyz/tm/issues/3222) Fix validator set updates so they are applied as a set, rather
...
- [evidence] [\#3286](https://github.com/vipernet-xyz/tm/issues/3286) Don't add committed evidence to evidence pool.
...
- p2p:
  - Partial fix for MITM attacks on the p2p connection. MITM conditions may
    still exist. See [\#3010](https://github.com/vipernet-xyz/tm/issues/3010).
- crypto:
...
* Go API
  - [crypto] [\#3278](https://github.com/vipernet-xyz/tm/issues/3278) Remove
    MixEntropy functions
  - [types] [\#3245](https://github.com/vipernet-xyz/tm/issues/3245) Commit uses `type CommitSig Vote` instead of `Vote` directly.
    In preparation for removing redundant fields from the commit [\#1648](https://github.com/vipernet-xyz/tm/issues/1648)

### IMPROVEMENTS:
- [consensus] [\#3246](https://github.com/vipernet-xyz/tm/issues/3246) Better logging and notes on recovery for corrupted WAL file
- [crypto] [\#3163](https://github.com/vipernet-xyz/tm/issues/3163) Use ethereum's libsecp256k1 go-wrapper for signatures when cgo is available
- [crypto] [\#3162](https://github.com/vipernet-xyz/tm/issues/3162) Wrap btcd instead of forking it to keep up with fixes (used if cgo is not available)
- [makefile] [\#3233](https://github.com/vipernet-xyz/tm/issues/3233) Use golangci-lint instead of go-metalinter
- [tools] [\#3218](https://github.com/vipernet-xyz/tm/issues/3218) Add go-deadlock tool to help detect deadlocks
- [tools] [\#3106](https://github.com/vipernet-xyz/tm/issues/3106) Add tm-signer-harness test harness for remote signers
- [tests] [\#3258](https://github.com/vipernet-xyz/tm/issues/3258) Fixed a bunch of non-deterministic test failures

### BUG FIXES:
- [node] [\#3186](https://github.com/vipernet-xyz/tm/issues/3186) EventBus and indexerService should be started before first block (for replay last block on handshake) execution (@ackratos)
- [p2p] [\#3232](https://github.com/vipernet-xyz/tm/issues/3232) Fix infinite loop leading to addrbook deadlock for seed nodes
- [p2p] [\#3247](https://github.com/vipernet-xyz/tm/issues/3247) Fix panic in SeedMode when calling FlushStop and OnStop
  concurrently
- [p2p] [\#3040](https://github.com/vipernet-xyz/tm/issues/3040) Fix MITM on secret connection by checking low-order points
- [privval] [\#3258](https://github.com/vipernet-xyz/tm/issues/3258) Fix race between sign requests and ping requests in socket that was causing messages to be corrupted
...
### IMPROVEMENTS:
- [pex] [\#3037](https://github.com/vipernet-xyz/tm/issues/3037) Only log "Reached max attempts to dial" once
- [rpc] [\#3159](https://github.com/vipernet-xyz/tm/issues/3159) Expose
  `triggered_timeout_commit` in the `/dump_consensus_state`

### BUG FIXES:
- [consensus] [\#3199](https://github.com/vipernet-xyz/tm/issues/3199) Fix consensus halt with no empty blocks from not resetting triggeredTimeoutCommit
- [p2p] [\#2967](https://github.com/vipernet-xyz/tm/issues/2967) Fix file descriptor leak
...
@ancazamfir](https://github.com/vipernet-xyz/tm/pull/3140).
...
That said, we just discovered [another bug](https://github.com/vipernet-xyz/tm/issues/3181),
...
* Apps
  - [state] [\#3049](https://github.com/vipernet-xyz/tm/issues/3049) Total voting power of the validator set is upper bounded by
    `MaxInt64 / 8`. Apps must ensure they do not return changes to the validator
    set that cause this maximum to be exceeded.

* Go API
  - [node] [\#3082](https://github.com/vipernet-xyz/tm/issues/3082) MetricsProvider now requires you to pass a chain ID
  - [types] [\#2713](https://github.com/vipernet-xyz/tm/issues/2713) Rename `TxProof.LeafHash` to `TxProof.Leaf`
  - [crypto/merkle] [\#2713](https://github.com/vipernet-xyz/tm/issues/2713) `SimpleProof.Verify` takes a `leaf` instead of a
    `leafHash` and performs the hashing itself

* Blockchain Protocol
  * [crypto/merkle] [\#2713](https://github.com/vipernet-xyz/tm/issues/2713) Merkle trees now match the RFC 6962 specification
  * [types] [\#3078](https://github.com/vipernet-xyz/tm/issues/3078) Re-order Timestamp and BlockID in CanonicalVote so it's
    consistent with CanonicalProposal (BlockID comes
    first)
  * [types] [\#3165](https://github.com/vipernet-xyz/tm/issues/3165) Hash of ConsensusParams only includes BlockSize.MaxBytes and
    BlockSize.MaxGas

* P2P Protocol
  - [consensus] [\#3049](https://github.com/vipernet-xyz/tm/issues/3049) Normalize priorities to not exceed `2*TotalVotingPower` to mitigate unfair proposer selection
    heavily preferring earlier joined validators in the case of an early bonded large validator unbonding

### FEATURES:

### IMPROVEMENTS:
- [rpc] [\#3065](https://github.com/vipernet-xyz/tm/issues/3065) Return maxPerPage (100), not defaultPerPage (30) if `per_page` is greater than the max 100.
- [instrumentation] [\#3082](https://github.com/vipernet-xyz/tm/issues/3082) Add `chain_id` label for all metrics

### BUG FIXES:
- [crypto] [\#3164](https://github.com/vipernet-xyz/tm/issues/3164) Update `btcd` fork for rare signRFC6979 bug
- [lite] [\#3171](https://github.com/vipernet-xyz/tm/issues/3171) Fix verifying large validator set changes
- [log] [\#3125](https://github.com/vipernet-xyz/tm/issues/3125) Fix year format
- [mempool] [\#3168](https://github.com/vipernet-xyz/tm/issues/3168) Limit tx size to fit in the max reactor msg size
- [scripts] [\#3147](https://github.com/vipernet-xyz/tm/issues/3147) Fix json2wal for large block parts (@bradyjoestar)
...
* CLI/RPC/Config
  ...
  - [config] [\#2992](https://github.com/vipernet-xyz/tm/issues/2992) `allow_duplicate_ip` is now set to false
  - [privval] [\#1181](https://github.com/vipernet-xyz/tm/issues/1181) Split `priv_validator.json` into immutable (`config/priv_validator_key.json`) and mutable (`data/priv_validator_state.json`) parts (@yutianwu)
  - [privval] [\#2926](https://github.com/vipernet-xyz/tm/issues/2926) Split up `PubKeyMsg` into `PubKeyRequest` and `PubKeyResponse` to be consistent with other message types
  - [privval] [\#2923](https://github.com/vipernet-xyz/tm/issues/2923) Listen for unix socket connections instead of dialing them

* Apps

* Go API
  - [types] [\#2981](https://github.com/vipernet-xyz/tm/issues/2981) Remove `PrivValidator.GetAddress()`
...
### FEATURES:
- [rpc] [\#3052](https://github.com/vipernet-xyz/tm/issues/3052) Include peer's remote IP in `/net_info`

### IMPROVEMENTS:
- [consensus] [\#3086](https://github.com/vipernet-xyz/tm/issues/3086) Log peerID on ignored votes (@srmo)
- [docs] [\#3061](https://github.com/vipernet-xyz/tm/issues/3061) Added specification for signing consensus msgs at
  ./docs/spec/consensus/signing.md
- [privval] [\#2948](https://github.com/vipernet-xyz/tm/issues/2948) Memoize pubkey so it's only requested once on startup
- [privval] [\#2923](https://github.com/vipernet-xyz/tm/issues/2923) Retry RemoteSigner connections on error

### BUG FIXES:

- [build] [\#3085](https://github.com/vipernet-xyz/tm/issues/3085) Fix `Version` field in build scripts (@husio)
- [crypto/multisig] [\#3102](https://github.com/vipernet-xyz/tm/issues/3102) Fix multisig keys address length
- [crypto/encoding] [\#3101](https://github.com/vipernet-xyz/tm/issues/3101) Fix `PubKeyMultisigThreshold` unmarshalling into `crypto.PubKey` interface
- [p2p/conn] [\#3111](https://github.com/vipernet-xyz/tm/issues/3111) Make SecretConnection thread safe
- [rpc] [\#3053](https://github.com/vipernet-xyz/tm/issues/3053) Fix internal error in `/tx_search` when results are empty
  (@gianfelipe93)
- [types] [\#2926](https://github.com/vipernet-xyz/tm/issues/2926) Do not panic if retrieving the privval's public key fails
...
- [mempool] [\#3036](https://github.com/vipernet-xyz/tm/issues/3036) Fix
...
* Go API
  - [dep] [\#3027](https://github.com/vipernet-xyz/tm/issues/3027) Revert to mainline Go crypto library, eliminating the modified
...
- [node] [\#3025](https://github.com/vipernet-xyz/tm/issues/3025) Validate NodeInfo addresses on startup.

### BUG FIXES:

- [p2p] [\#3025](https://github.com/vipernet-xyz/tm/pull/3025) Revert to using defers in addrbook.  Fixes deadlocks in pex and consensus upon invalid ExternalAddr/ListenAddr configuration.
...
### FEATURES:
- [rpc] [\#2964](https://github.com/vipernet-xyz/tm/issues/2964) Add `UnconfirmedTxs(limit)` and `NumUnconfirmedTxs()` methods to HTTP/Local clients (@danil-lashin)
- [docs] [\#3004](https://github.com/vipernet-xyz/tm/issues/3004) Enable full-text search on docs pages

### IMPROVEMENTS:
- [consensus] [\#2971](https://github.com/vipernet-xyz/tm/issues/2971) Return error if ValidatorSet is empty after InitChain
  (@leo-xinwang)
- [ci/cd] [\#3005](https://github.com/vipernet-xyz/tm/issues/3005) Updated CircleCI job to trigger website build when docs are updated
- [docs] Various updates

### BUG FIXES:
- [cmd] [\#2983](https://github.com/vipernet-xyz/tm/issues/2983) `testnet` command always sets `addr_book_strict = false`
- [config] [\#2980](https://github.com/vipernet-xyz/tm/issues/2980) Fix CORS options formatting
- [kv indexer] [\#2912](https://github.com/vipernet-xyz/tm/issues/2912) Don't ignore key when executing CONTAINS
- [mempool] [\#2961](https://github.com/vipernet-xyz/tm/issues/2961) Call `notifyTxsAvailable` if there're txs left after committing a block, but recheck=false
- [mempool] [\#2994](https://github.com/vipernet-xyz/tm/issues/2994) Reject txs with negative GasWanted
- [p2p] [\#2990](https://github.com/vipernet-xyz/tm/issues/2990) Fix a bug where seeds don't disconnect from a peer after 3h
- [consensus] [\#3006](https://github.com/vipernet-xyz/tm/issues/3006) Save state after InitChain only when stateHeight is also 0 (@james-ray)
...
issue](https://github.com/vipernet-xyz/tm/issues/2718#issuecomment-440888677)
...
* CLI/RPC/Config
  - [rpc] [\#2932](https://github.com/vipernet-xyz/tm/issues/2932) Rename `accum` to `proposer_priority`

* Go API
  - [db] [\#2913](https://github.com/vipernet-xyz/tm/pull/2913)
    ReverseIterator API change: start < end, and end is exclusive.
  - [types] [\#2932](https://github.com/vipernet-xyz/tm/issues/2932) Rename `Validator.Accum` to `Validator.ProposerPriority`

* Blockchain Protocol
  - [state] [\#2714](https://github.com/vipernet-xyz/tm/issues/2714) Validators can now only use pubkeys allowed within
    ConsensusParams.Validator.PubKeyTypes

* P2P Protocol
  - [consensus] [\#2871](https://github.com/vipernet-xyz/tm/issues/2871)
    Remove *ProposalHeartbeat* message as it serves no real purpose (@srmo)
  - [state] Fixes for proposer selection:
    - [\#2785](https://github.com/vipernet-xyz/tm/issues/2785) Accum for new validators is `-1.125*totalVotingPower` instead of 0
    - [\#2941](https://github.com/vipernet-xyz/tm/issues/2941) val.Accum is preserved during ValidatorSet.Update to avoid being
      reset to 0

### IMPROVEMENTS:

- [state] [\#2929](https://github.com/vipernet-xyz/tm/issues/2929) Minor refactor of updateState logic (@danil-lashin)
- [node] [\#2959](https://github.com/vipernet-xyz/tm/issues/2959) Allow node to start even if software's BlockProtocol is
  different from state's BlockProtocol
- [pex] [\#2959](https://github.com/vipernet-xyz/tm/issues/2959) Pex reactor logger uses `module=pex`

### BUG FIXES:

- [p2p] [\#2968](https://github.com/vipernet-xyz/tm/issues/2968) Panic on transport error rather than continuing to run but not
  accept new connections
- [p2p] [\#2969](https://github.com/vipernet-xyz/tm/issues/2969) Fix mismatch in peer count between `/net_info` and the prometheus
  metrics
- [rpc] [\#2408](https://github.com/vipernet-xyz/tm/issues/2408) `/broadcast_tx_commit`: Fix "interface conversion: interface {} in nil, not EventDataTx" panic (could happen if somebody sent a tx using `/broadcast_tx_commit` while Tendermint was being stopped)
- [state] [\#2785](https://github.com/vipernet-xyz/tm/issues/2785) Fix accum for new validators to be `-1.125*totalVotingPower`
  instead of 0, forcing them to wait before becoming the proposer. Also:
    - do not batch clip
    - keep accums averaged near 0
- [txindex/kv] [\#2925](https://github.com/vipernet-xyz/tm/issues/2925) Don't return false positives when range searching for a prefix of a tag value
- [types] [\#2938](https://github.com/vipernet-xyz/tm/issues/2938) Fix regression in v0.26.4 where we panic on empty
  genDoc.Validators
- [types] [\#2941](https://github.com/vipernet-xyz/tm/issues/2941) Preserve val.Accum during ValidatorSet.Update to avoid it being
...
- [rpc] [\#2747](https://github.com/vipernet-xyz/tm/issues/2747) Enable subscription to tags emitted from `BeginBlock`/`EndBlock` (@kostko)
- [types] [\#2747](https://github.com/vipernet-xyz/tm/issues/2747) Add `ResultBeginBlock` and `ResultEndBlock` fields to `EventDataNewBlock`
    and `EventDataNewBlockHeader` to support subscriptions (@kostko)
- [types] [\#2918](https://github.com/vipernet-xyz/tm/issues/2918) Add Marshal, MarshalTo, Unmarshal methods to various structs
  to support Protobuf compatibility (@nagarajmanjunath)

### IMPROVEMENTS:

- [config] [\#2877](https://github.com/vipernet-xyz/tm/issues/2877) Add `blocktime_iota` to the config.toml (@ackratos)
    - NOTE: this should be a ConsensusParam, not part of the config, and will be
      removed from the config at a later date
      ([\#2920](https://github.com/vipernet-xyz/tm/issues/2920).
- [mempool] [\#2882](https://github.com/vipernet-xyz/tm/issues/2882) Add txs from Update to cache
- [mempool] [\#2891](https://github.com/vipernet-xyz/tm/issues/2891) Remove local int64 counter from being stored in every tx
- [node] [\#2866](https://github.com/vipernet-xyz/tm/issues/2866) Add ability to instantiate IPCVal (@joe-bowman)

### BUG FIXES:

- [blockchain] [\#2731](https://github.com/vipernet-xyz/tm/issues/2731) Retry both blocks if either is bad to avoid getting stuck during fast sync (@goolAdapter)
- [consensus] [\#2893](https://github.com/vipernet-xyz/tm/issues/2893) Use genDoc.Validators instead of state.NextValidators on replay when appHeight==0 (@james-ray)
- [log] [\#2868](https://github.com/vipernet-xyz/tm/issues/2868) Fix `module=main` setting overriding all others
...
- [rpc] [\#2808](https://github.com/vipernet-xyz/tm/issues/2808) Fix `accum` field in `/validators` by calling `IncrementAccum` if necessary
- [rpc] [\#2811](https://github.com/vipernet-xyz/tm/issues/2811) Allow integer IDs in JSON-RPC requests (@tomtau)
- [txindex/kv] [\#2759](https://github.com/vipernet-xyz/tm/issues/2759) Fix tx.height range queries
- [txindex/kv] [\#2775](https://github.com/vipernet-xyz/tm/issues/2775) Order tx results by index if height is the same
- [txindex/kv] [\#2908](https://github.com/vipernet-xyz/tm/issues/2908) Don't return false positives when searching for a prefix of a tag value
...
* Go API
  - [rpc] [\#2791](https://github.com/vipernet-xyz/tm/issues/2791) Functions that start HTTP servers are now blocking:
  ...
  - [rpc] [\#2767](https://github.com/vipernet-xyz/tm/issues/2767) Subscribing to events
...
- [log] [\#2843](https://github.com/vipernet-xyz/tm/issues/2843) New `log_format` config option, which can be set to 'plain' for colored
  text or 'json' for JSON output
- [types] [\#2767](https://github.com/vipernet-xyz/tm/issues/2767) New event types EventDataNewRound (with ProposerInfo) and EventDataCompleteProposal (with BlockID). (@kevlubkcm)

### IMPROVEMENTS:

- [dep] [\#2844](https://github.com/vipernet-xyz/tm/issues/2844) Dependencies are no longer pinned to an exact version in the
  Gopkg.toml:
  - Serialization libs are allowed to vary by patch release
  - Other libs are allowed to vary by minor release
- [p2p] [\#2857](https://github.com/vipernet-xyz/tm/issues/2857) "Send failed" is logged at debug level instead of error.
- [rpc] [\#2780](https://github.com/vipernet-xyz/tm/issues/2780) Add read and write timeouts to HTTP servers
- [state] [\#2848](https://github.com/vipernet-xyz/tm/issues/2848) Make "Update to validators" msg value pretty (@danil-lashin)

### BUG FIXES:
- [consensus] [\#2819](https://github.com/vipernet-xyz/tm/issues/2819) Don't send proposalHearbeat if not a validator
- [docs] [\#2859](https://github.com/vipernet-xyz/tm/issues/2859) Fix ConsensusParams details in spec
- [libs/autofile] [\#2760](https://github.com/vipernet-xyz/tm/issues/2760) Comment out autofile permissions check - should fix
  running Tendermint on Windows
- [p2p] [\#2869](https://github.com/vipernet-xyz/tm/issues/2869) Set connection config properly instead of always using default
- [p2p/pex] [\#2802](https://github.com/vipernet-xyz/tm/issues/2802) Seed mode fixes:
...
- [rpc] [\#2582](https://github.com/vipernet-xyz/tm/issues/2582) Enable CORS on RPC API (@hleb-albau)

### BUG FIXES:

- [abci] [\#2748](https://github.com/vipernet-xyz/tm/issues/2748) Unlock mutex in localClient so even when app panics (e.g. during CheckTx), consensus continue working
- [abci] [\#2748](https://github.com/vipernet-xyz/tm/issues/2748) Fix DATA RACE in localClient
- [amino] [\#2822](https://github.com/vipernet-xyz/tm/issues/2822) Update to v0.14.1 to support compiling on 32-bit platforms
- [rpc] [\#2748](https://github.com/vipernet-xyz/tm/issues/2748) Drain channel before calling Unsubscribe(All) in `/broadcast_tx_commit`
...
- [consensus] [\#2704](https://github.com/vipernet-xyz/tm/issues/2704) Simplify valid POL round logic
- [docs] [\#2749](https://github.com/vipernet-xyz/tm/issues/2749) Deduplicate some ABCI docs
- [mempool] More detailed log messages
    - [\#2724](https://github.com/vipernet-xyz/tm/issues/2724)
    - [\#2762](https://github.com/vipernet-xyz/tm/issues/2762)

### BUG FIXES:

- [autofile] [\#2703](https://github.com/vipernet-xyz/tm/issues/2703) Do not panic when checking Head size
- [crypto/merkle] [\#2756](https://github.com/vipernet-xyz/tm/issues/2756) Fix crypto/merkle ProofOperators.Verify to check bounds on keypath parts.
- [mempool] fix a bug where we create a WAL despite `wal_dir` being empty
- [p2p] [\#2771](https://github.com/vipernet-xyz/tm/issues/2771) Fix `peer-id` label name to `peer_id` in prometheus metrics
- [p2p] [\#2797](https://github.com/vipernet-xyz/tm/pull/2797) Fix IDs in peer NodeInfo and require them for addresses
  in AddressBook
- [p2p] [\#2797](https://github.com/vipernet-xyz/tm/pull/2797) Do not close conn immediately after sending pex addrs in seed mode. Partial fix for [\#2092](https://github.com/vipernet-xyz/tm/issues/2092).
...
* CLI/RPC/Config
  * [config] [\#2232](https://github.com/vipernet-xyz/tm/issues/2232) Timeouts are now strings like "3s" and "100ms", not ints
  * [config] [\#2505](https://github.com/vipernet-xyz/tm/issues/2505) Remove Mempool.RecheckEmpty (it was effectively useless anyways)
  * [config] [\#2490](https://github.com/vipernet-xyz/tm/issues/2490) `mempool.wal` is disabled by default
  * [privval] [\#2459](https://github.com/vipernet-xyz/tm/issues/2459) Split `SocketPVMsg`s implementations into Request and Response, where the Response may contain a error message (returned by the remote signer)
  * [state] [\#2644](https://github.com/vipernet-xyz/tm/issues/2644) Add Version field to State, breaking the format of State as
    encoded on disk.
  * [rpc] [\#2298](https://github.com/vipernet-xyz/tm/issues/2298) `/abci_query` takes `prove` argument instead of `trusted` and switches the default
    behaviour to `prove=false`
  * [rpc] [\#2654](https://github.com/vipernet-xyz/tm/issues/2654) Remove all `node_info.other.*_version` fields in `/status` and
    `/net_info`
  * [rpc] [\#2636](https://github.com/vipernet-xyz/tm/issues/2636) Remove
    `_params` suffix from fields in `consensus_params`.

* Apps
  * [abci] [\#2298](https://github.com/vipernet-xyz/tm/issues/2298) ResponseQuery.Proof is now a structured merkle.Proof, not just
    arbitrary bytes
  * [abci] [\#2644](https://github.com/vipernet-xyz/tm/issues/2644) Add Version to Header and shift all fields by one
  * [abci] [\#2662](https://github.com/vipernet-xyz/tm/issues/2662) Bump the field numbers for some `ResponseInfo` fields to make room for
      `AppVersion`
  * [abci] [\#2636](https://github.com/vipernet-xyz/tm/issues/2636) Updates to ConsensusParams
...
* Go API
  * [config] [\#2232](https://github.com/vipernet-xyz/tm/issues/2232) Timeouts are time.Duration, not ints
  * [crypto/merkle & lite] [\#2298](https://github.com/vipernet-xyz/tm/issues/2298) Various changes to accomodate General Merkle trees
  * [crypto/merkle] [\#2595](https://github.com/vipernet-xyz/tm/issues/2595) Remove all Hasher objects in favor of byte slices
  * [crypto/merkle] [\#2635](https://github.com/vipernet-xyz/tm/issues/2635) merkle.SimpleHashFromTwoHashes is no longer exported
  * [node] [\#2479](https://github.com/vipernet-xyz/tm/issues/2479) Remove node.RunForever
  * [rpc/client] [\#2298](https://github.com/vipernet-xyz/tm/issues/2298) `ABCIQueryOptions.Trusted` -> `ABCIQueryOptions.Prove`
  * [types] [\#2298](https://github.com/vipernet-xyz/tm/issues/2298) Remove `Index` and `Total` fields from `TxProof`.
  * [types] [\#2598](https://github.com/vipernet-xyz/tm/issues/2598)
    `VoteTypeXxx` are now of type `SignedMsgType byte` and named `XxxType`, eg.
    `PrevoteType`, `PrecommitType`.
  * [types] [\#2636](https://github.com/vipernet-xyz/tm/issues/2636) Rename fields in ConsensusParams to remove `Params` suffixes
  * [types] [\#2735](https://github.com/vipernet-xyz/tm/issues/2735) Simplify Proposal message to align with spec

* Blockchain Protocol
  * [crypto/tmhash] [\#2732](https://github.com/vipernet-xyz/tm/issues/2732) TMHASH is now full 32-byte SHA256
    * All hashes in the block header and Merkle trees are now 32-bytes
    * PubKey Addresses are still only 20-bytes
  * [state] [\#2587](https://github.com/vipernet-xyz/tm/issues/2587) Require block.Time of the fist block to be genesis time
  * [state] [\#2644](https://github.com/vipernet-xyz/tm/issues/2644) Require block.Version to match state.Version
  * [types] Update SignBytes for `Vote`/`Proposal`/`Heartbeat`:
    * [\#2459](https://github.com/vipernet-xyz/tm/issues/2459) Use amino encoding instead of JSON in `SignBytes`.
    * [\#2598](https://github.com/vipernet-xyz/tm/issues/2598) Reorder fields and use fixed sized encoding.
    * [\#2598](https://github.com/vipernet-xyz/tm/issues/2598) Change `Type` field from `string` to `byte` and use new
      `SignedMsgType` to enumerate.
  * [types] [\#2730](https://github.com/vipernet-xyz/tm/issues/2730) Use
    same order for fields in `Vote` as in the SignBytes
  * [types] [\#2732](https://github.com/vipernet-xyz/tm/issues/2732) Remove the address field from the validator hash
  * [types] [\#2644](https://github.com/vipernet-xyz/tm/issues/2644) Add Version struct to Header
  * [types] [\#2609](https://github.com/vipernet-xyz/tm/issues/2609) ConsensusParams.Hash() is the hash of the amino encoded
    struct instead of the Merkle tree of the fields
  * [types] [\#2670](https://github.com/vipernet-xyz/tm/issues/2670) Header.Hash() builds Merkle tree out of fields in the same
    order they appear in the header, instead of sorting by field name
  * [types] [\#2682](https://github.com/vipernet-xyz/tm/issues/2682) Use proto3 `varint` encoding for ints that are usually unsigned (instead of zigzag encoding).
  * [types] [\#2636](https://github.com/vipernet-xyz/tm/issues/2636) Add Validator field to ConsensusParams
      (Used to control which pubkey types validators can use, by abci type).

* P2P Protocol
  * [consensus] [\#2652](https://github.com/vipernet-xyz/tm/issues/2652)
    Replace `CommitStepMessage` with `NewValidBlockMessage`
  * [consensus] [\#2735](https://github.com/vipernet-xyz/tm/issues/2735) Simplify `Proposal` message to align with spec
  * [consensus] [\#2730](https://github.com/vipernet-xyz/tm/issues/2730)
    Add `Type` field to `Proposal` and use same order of fields as in the
    SignBytes for both `Proposal` and `Vote`
  * [p2p] [\#2654](https://github.com/vipernet-xyz/tm/issues/2654) Add `ProtocolVersion` struct with protocol versions to top of
    DefaultNodeInfo and require `ProtocolVersion.Block` to match during peer handshake


### FEATURES:
- [abci] [\#2557](https://github.com/vipernet-xyz/tm/issues/2557) Add `Codespace` field to `Response{CheckTx, DeliverTx, Query}`
- [abci] [\#2662](https://github.com/vipernet-xyz/tm/issues/2662) Add `BlockVersion` and `P2PVersion` to `RequestInfo`
- [crypto/merkle] [\#2298](https://github.com/vipernet-xyz/tm/issues/2298) General Merkle Proof scheme for chaining various types of Merkle trees together
- [docs/architecture] [\#1181](https://github.com/vipernet-xyz/tm/issues/1181) S
...
- [config] [\#2232](https://github.com/vipernet-xyz/tm/issues/2232) Added ValidateBasic method, which performs basic checks
- [crypto/ed25519] [\#2558](https://github.com/vipernet-xyz/tm/issues/2558) Switch to use latest `golang.org/x/crypto` through our fork at
  github.com/tendermint/crypto
- [libs/log] [\#2707](https://github.com/vipernet-xyz/tm/issues/2707) Add year to log format (@yutianwu)
- [tools] [\#2238](https://github.com/vipernet-xyz/tm/issues/2238) Binary dependencies are now locked to a specific git commit

### BUG FIXES:
- [\#2711](https://github.com/vipernet-xyz/tm/issues/2711) Validate all incoming reactor messages. Fixes various bugs due to negative ints.
- [autofile] [\#2428](https://github.com/vipernet-xyz/tm/issues/2428) Group.RotateFile need call Flush() before rename (@goolAdapter)
- [common] [\#2533](https://github.com/vipernet-xyz/tm/issues/2533) Fixed a bug in the `BitArray.Or` method
- [common] [\#2506](https://github.com/vipernet-xyz/tm/issues/2506) Fixed a bug in the `BitArray.Sub` method (@james-ray)
- [common] [\#2534](https://github.com/vipernet-xyz/tm/issues/2534) Fix `BitArray.PickRandom` to choose uniformly from true bits
- [consensus] [\#1690](https://github.com/vipernet-xyz/tm/issues/1690) Wait for
  timeoutPrecommit before starting next round
- [consensus] [\#1745](https://github.com/vipernet-xyz/tm/issues/1745) Wait for
  Proposal or timeoutProposal before entering prevote
- [consensus] [\#2642](https://github.com/vipernet-xyz/tm/issues/2642) Only propose ValidBlock, not LockedBlock
- [consensus] [\#2642](https://github.com/vipernet-xyz/tm/issues/2642) Initialized ValidRound and LockedRound to -1
- [consensus] [\#1637](https://github.com/vipernet-xyz/tm/issues/1637) Limit the amount of evidence that can be included in a
  block
- [consensus] [\#2652](https://github.com/vipernet-xyz/tm/issues/2652) Ensure valid block property with faulty proposer
- [evidence] [\#2515](https://github.com/vipernet-xyz/tm/issues/2515) Fix db iter leak (@goolAdapter)
- [libs/event] [\#2518](https://github.com/vipernet-xyz/tm/issues/2518) Fix event concurrency flaw (@goolAdapter)
- [node] [\#2434](https://github.com/vipernet-xyz/tm/issues/2434) Make node respond to signal interrupts while sleeping for genesis time
- [state] [\#2616](https://github.com/vipernet-xyz/tm/issues/2616) Pass nil to NewValidatorSet() when genesis file's Validators field is nil
- [p2p] [\#2555](https://github.com/vipernet-xyz/tm/issues/2555) Fix p2p switch FlushThrottle value (@goolAdapter)
- [p2p] [\#2668](https://github.com/vipernet-xyz/tm/issues/2668) Reconnect to originally dialed address (not self-reported address) for persistent peers
...
[ADR-012](https://github.com/vipernet-xyz/tm/blob/main/docs/architecture/adr-012-peer-transport.md).

BREAKING CHANGES:

* CLI/RPC/Config
  * [rpc] [\#2391](https://github.com/vipernet-xyz/tm/issues/2391) /status `result.node_info.other` became a map
  * [types] [\#2364](https://github.com/vipernet-xyz/tm/issues/2364) Remove `TxSize` and `BlockGossip` from `ConsensusParams`
...
* Apps
  * [mempool] [\#2360](https://github.com/vipernet-xyz/tm/issues/2360) Mempool tracks the `ResponseCheckTx.GasWanted` and
...
* Go API
  * [libs/common] [\#2431](https://github.com/vipernet-xyz/tm/issues/2431) Remove Word256 due to lack of use
  * [libs/common] [\#2452](https://github.com/vipernet-xyz/tm/issues/2452) Remove the following functions due to lack of use:
...
FEATURES:
- [rpc] [\#2415](https://github.com/vipernet-xyz/tm/issues/2415) New `/consensus_params?height=X` endpoint to query the consensus
  params at any height (@scriptonist)
- [types] [\#1714](https://github.com/vipernet-xyz/tm/issues/1714) Add Address to GenesisValidator
- [metrics] [\#2337](https://github.com/vipernet-xyz/tm/issues/2337) `consensus.block_interval_metrics` is now gauge, not histogram (you will be able to see spikes, if any)
- [libs] [\#2286](https://github.com/vipernet-xyz/tm/issues/2286) Panic if `autofile` or `db/fsdb` permissions change from 0600.

IMPROVEMENTS:
- [libs/db] [\#2371](https://github.com/vipernet-xyz/tm/issues/2371) Output error instead of panic when the given `db_backend` is not initialised (@bradyjoestar)
- [mempool] [\#2399](https://github.com/vipernet-xyz/tm/issues/2399) Make mempool cache a proper LRU (@bradyjoestar)
- [p2p] [\#2126](https://github.com/vipernet-xyz/tm/issues/2126) Introduce PeerTransport interface to improve isolation of concerns
- [libs/common] [\#2326](https://github.com/vipernet-xyz/tm/issues/2326) Service returns ErrNotStarted

BUG FIXES:
- [node] [\#2294](https://github.com/vipernet-xyz/tm/issues/2294) Delay starting node until Genesis time
- [consensus] [\#2048](https://github.com/vipernet-xyz/tm/issues/2048) Correct peer statistics for marking peer as good
- [rpc] [\#2460](https://github.com/vipernet-xyz/tm/issues/2460) StartHTTPAndTLSServer() now passes StartTLS() errors back to the caller rather than hanging forever.
- [p2p] [\#2047](https://github.com/vipernet-xyz/tm/issues/2047) Accept new connections asynchronously
- [tm-bench] [\#2410](https://github.com/vipernet-xyz/tm/issues/2410) Enforce minimum transaction size (@WALL-E)
...
[here](https://github.com/vipernet-xyz/tm/tree/develop/docs/architecture)
or in the [open Pull Requests](https://github.com/vipernet-xyz/tm/pulls).
You can also check in on the [issues marked as
breaking](https://github.com/vipernet-xyz/tm/issues?q=is%3Aopen+is%3Aissue+label%3Abreaking).

BREAKING CHANGES:

* CLI/RPC/Config
  - [config] [\#2169](https://github.com/vipernet-xyz/tm/issues/2169) Replace MaxNumPeers with MaxNumInboundPeers and MaxNumOutboundPeers
  - [config] [\#2300](https://github.com/vipernet-xyz/tm/issues/2300) Reduce default mempool size from 100k to 5k, until ABCI rechecking is implemented.
  - [rpc] [\#1815](https://github.com/vipernet-xyz/tm/issues/1815) `/commit` returns a `signed_header` field instead of everything being top-level

* Apps
  - [abci] Added address of the original proposer of the block to Header
  - [abci] Change ABCI Header to match Tendermint exactly
  - [abci] [\#2159](https://github.com/vipernet-xyz/tm/issues/2159) Update use of `Validator` (see
    [ADR-018](https://github.com/vipernet-xyz/tm/blob/main/docs/architecture/adr-018-ABCI-Validators.md)):
    - Remove PubKey from `Validator` (so it's just Address and Power)
    - Introduce `ValidatorUpdate` (with just PubKey and Power)
    - InitChain and EndBlock use ValidatorUpdate
    - Update field names and types in BeginBlock
  - [state] [\#1815](https://github.com/vipernet-xyz/tm/issues/1815) Validator set changes are now delayed by one block
    - updates returned in ResponseEndBlock for block H will be included in RequestBeginBlock for block H+2

* Go API
  - [lite] [\#1815](https://github.com/vipernet-xyz/tm/issues/1815) Complete refactor of the package
  - [node] [\#2212](https://github.com/vipernet-xyz/tm/issues/2212) NewNode now accepts a `*p2p.NodeKey` (@bradyjoestar)
  - [libs/common] [\#2199](https://github.com/vipernet-xyz/tm/issues/2199) Remove Fmt, in favor of fmt.Sprintf
  - [libs/common] SplitAndTrim was deleted
  - [libs/common] [\#2274](https://github.com/vipernet-xyz/tm/issues/2274) Remove unused Math functions like MaxInt, MaxInt64,
    MinInt, MinInt64 (@Ahmah2009)
  - [libs/clist] Panics if list extends beyond MaxLength
  - [crypto] [\#2205](https://github.com/vipernet-xyz/tm/issues/2205) Rename AminoRoute variables to no longer be prefixed by signature type.

* Blockchain Protocol
  - [state] [\#1815](https://github.com/vipernet-xyz/tm/issues/1815) Validator set changes are now delayed by one block (!)
    - Add NextValidatorSet to State, changes on-disk representation of state
  - [state] [\#2184](https://github.com/vipernet-xyz/tm/issues/2184) Enforce ConsensusParams.BlockSize.MaxBytes (See
    [ADR-020](https://github.com/vipernet-xyz/tm/blob/main/docs/architecture/adr-020-block-size.md)).
    - Remove ConsensusParams.BlockSize.MaxTxs
    - Introduce maximum sizes for all components of a block, including ChainID
  - [types] Updates to the block Header:
    - [\#1815](https://github.com/vipernet-xyz/tm/issues/1815) NextValidatorsHash - hash of the validator set for the next block,
      so the current validators actually sign over the hash for the new
      validators
    - [\#2106](https://github.com/vipernet-xyz/tm/issues/2106) ProposerAddress - address of the block's original proposer
  - [consensus] [\#2203](https://github.com/vipernet-xyz/tm/issues/2203) Implement BFT time
    - Timestamp in block must be monotonic and equal the median of timestamps in block's LastCommit
  - [crypto] [\#2239](https://github.com/vipernet-xyz/tm/issues/2239) Secp256k1 signature changes (See
    [ADR-014](https://github.com/vipernet-xyz/tm/blob/main/docs/architecture/adr-014-secp-malleability.md)):
    - format changed from DER to `r || s`, both little endian encoded as 32 bytes.
    - malleability removed by requiring `s` to be in canonical form.

* P2P Protocol
  - [p2p] [\#2263](https://github.com/vipernet-xyz/tm/issues/2263) Update secret connection to use a little endian encoded nonce
  - [blockchain] [\#2213](https://github.com/vipernet-xyz/tm/issues/2213) Fix Amino routes for blockchain reactor messages
    (@peerlink)


FEATURES:
- [types] [\#2015](https://github.com/vipernet-xyz/tm/issues/2015) Allow genesis file to have 0 validators (@b00f)
  - Initial validator set can be determined by the app in ResponseInitChain
- [rpc] [\#2161](https://github.com/vipernet-xyz/tm/issues/2161) New event `ValidatorSetUpdates` for when the validator set changes
- [crypto/multisig] [\#2164](https://github.com/vipernet-xyz/tm/issues/2164) Introduce multisig pubkey and signature format
- [libs/db] [\#2293](https://github.com/vipernet-xyz/tm/issues/2293) Allow passing options through when creating instances of leveldb dbs

IMPROVEMENTS:
- [docs] Lint documentation with `write-good` and `stop-words`.
- [docs] [\#2249](https://github.com/vipernet-xyz/tm/issues/2249) Refactor, deduplicate, and improve the ABCI docs and spec (with thanks to @ttmc).
- [scripts] [\#2196](https://github.com/vipernet-xyz/tm/issues/2196) Added json2wal tool, which is supposed to help our users restore (@bradyjoestar)
  corrupted WAL files and compose test WAL files (@bradyjoestar)
- [mempool] [\#2234](https://github.com/vipernet-xyz/tm/issues/2234) Now stores txs by hash inside of the cache, to mitigate memory leakage
- [mempool] [\#2166](https://github.com/vipernet-xyz/tm/issues/2166) Set explicit capacity for map when updating txs (@bluele)

BUG FIXES:
- [config] [\#2284](https://github.com/vipernet-xyz/tm/issues/2284) Replace `db_path` with `db_dir` from automatically generated configuration files.
- [mempool] [\#2188](https://github.com/vipernet-xyz/tm/issues/2188) Fix OOM issue from cache map and list getting out of sync
- [state] [\#2051](https://github.com/vipernet-xyz/tm/issues/2051) KV store index supports searching by `tx.height` (@ackratos)
- [rpc] [\#2327](https://github.com/vipernet-xyz/tm/issues/2327) `/dial_peers` does not try to dial existing peers
- [node] [\#2323](https://github.com/vipernet-xyz/tm/issues/2323) Filter empty strings from config lists (@james-ray)
- [abci/client] [\#2236](https://github.com/vipernet-xyz/tm/issues/2236) Fix closing GRPC connection (@bradyjoestar)
...
BUG FIXES:
- [libs/autofile] [\#2261](https://github.com/vipernet-xyz/tm/issues/2261) Fix log rotation so it actually happens.
    - Fixes issues with consensus WAL growing unbounded ala [\#2259](https://github.com/vipernet-xyz/tm/issues/2259)
...
- [crypto] Switch crypto.Signature from interface to []byte for space efficiency
  [#2128](https://github.com/vipernet-xyz/tm/pull/2128)
...
- [p2p] Remove salsa and ripemd primitives, in favor of using chacha as a stream cipher, and hkdf [#2054](https://github.com/vipernet-xyz/tm/pull/2054)
...
- [blockchain] Improve fast-sync logic
  [#1805](https://github.com/vipernet-xyz/tm/pull/1805)
    - tweak params
...
- [p2p] begin connecting to peers as soon a seed node provides them to you ([#2093](https://github.com/vipernet-xyz/tm/issues/2093))

BUG FIXES:
- [common] Safely handle cases where atomic write files already exist [#2109](https://github.com/vipernet-xyz/tm/issues/2109)
- [privval] fix a deadline for accepting new connections in socket private
  validator.
- [p2p] Allow startup if a configured seed node's IP can't be resolved ([#1716](https://github.com/vipernet-xyz/tm/issues/1716))
- [node] Fully exit when CTRL-C is pressed even if consensus state panics [#2072](https://github.com/vipernet-xyz/tm/issues/2072)

[i1815]: https://github.com/vipernet-xyz/tm/pull/1815
...
- [rpc]: changed the output format for the `/status` endpoint (see https://godoc.org/github.com/vipernet-xyz/tm/rpc/core#Status)
...
IMPROVEMENTS:
- rpc/client: can act as event bus subscriber (See https://github.com/vipernet-xyz/tm/issues/945).
...
- Config and Flags:
  - The `config` map is replaced with a [`Config` struct](https://github.com/vipernet-xyz/tm/blob/v0.10.0/config/config.go#L11),
