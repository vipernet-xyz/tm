...
[releases]: https://github.com/vipernet-xyz/tm/blob/v0.37.x/RELEASES.md#large-scale-testnets
...
2. Extract the latency report and the raw latencies for all the experiments. Run these commands from the directory containing the blockstore
    * `go run github.com/vipernet-xyz/tm/test/loadtime/cmd/report@3ec6e424d --database-type goleveldb --data-dir ./ > results/report.txt`
    * `go run github.com/vipernet-xyz/tm/test/loadtime/cmd/report@3ec6e424d --database-type goleveldb --data-dir ./ --csv results/raw.csv`
