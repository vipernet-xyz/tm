...
(ABCI)](https://github.com/vipernet-xyz/tm/tree/v0.34.x/abci)
...
[Tendermint Core](https://github.com/vipernet-xyz/tm) (the
...
specification](https://github.com/vipernet-xyz/tm/blob/v0.34.x/spec/abci/abci.md).
