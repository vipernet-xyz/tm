...
script](https://github.com/vipernet-xyz/tm/blob/v0.34.x/networks/remote/integration.sh)
...
directory](https://github.com/vipernet-xyz/tm/tree/v0.34.x/networks/remote/ansible)
