...
To use your own ABCI applications with 4-node setup edit the [docker-compose.yaml](https://github.com/vipernet-xyz/tm/blob/v0.34.x/docker-compose.yml) file and add image to your ABCI application.
...
Override the [command](https://github.com/vipernet-xyz/tm/blob/v0.34.x/networks/local/localnode/Dockerfile#L12) in each node to connect to it's ABCI.
...
Similarly do for node1, node2 and node3 then [run testnet](https://github.com/vipernet-xyz/tm/blob/v0.34.x/docs/networks/docker-compose.md#run-a-testnet)
