...
definition](https://github.com/vipernet-xyz/tm/blob/v0.34.x/types/genesis.go)).
...
- `consensus_params` [spec](https://github.com/vipernet-xyz/tm/blob/v0.34.x/spec/core/data_structures.md#consensusparams)
    - `block`
...
See the
[UPGRADING.md](https://github.com/vipernet-xyz/tm/blob/v0.34.x/UPGRADING.md)
