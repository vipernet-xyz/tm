...
Algorithm](https://github.com/vipernet-xyz/tm/blob/v0.34.x/spec/consensus/consensus.md).
...
- `abci-client` As mentioned in [Application Development Guide](../app-dev/app-development.md), Tendermint acts as an ABCI
  ...
  be found [here](https://github.com/vipernet-xyz/tm/blob/v0.34.x/abci/client).
...
- `events` Simple event notification system. The list of events can be
  found
  [here](https://github.com/vipernet-xyz/tm/blob/v0.34.x/types/events.go).
...
- `p2p` Provides an abstraction around peer-to-peer communication. For
  ...
  [README](https://github.com/vipernet-xyz/tm/blob/v0.34.x/p2p/README.md).
- `rpc` [Tendermint's RPC](./rpc.md).
- `rpc-server` RPC server. For implementation details, please read the
  [doc.go](https://github.com/vipernet-xyz/tm/blob/v0.34.x/rpc/jsonrpc/doc.go).
