...
git clone https://github.com/vipernet-xyz/tm.git
cd tendermint
## build
make tools
make build
...
cd $GOPATH/src/github.com/vipernet-xyz/tm/networks/remote/terraform
...
cd $GOPATH/src/github.com/vipernet-xyz/tm/networks/remote/ansible

# create config dirs
tendermint testnet

ansible-playbook -i inventory/digital_ocean.py -l sentrynet install.yml
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/vipernet-xyz/tm/build/tendermint -e CONFIGDIR=$GOPATH/src/github.com/vipernet-xyz/tm/networks/remote/ansible/mytestnet
...
old_ansible_file=$GOPATH/src/github.com/vipernet-xyz/tm/networks/remote/ansible/roles/install/templates/systemd.service.j2
rm $old_ansible_file
