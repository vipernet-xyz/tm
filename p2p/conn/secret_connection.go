...
import (
	...
	"github.com/vipernet-xyz/tm/libs/async"
	"github.com/vipernet-xyz/tm/libs/protoio"
	tmsync "github.com/vipernet-xyz/tm/libs/sync"
	tmp2p "github.com/vipernet-xyz/tm/proto/tendermint/p2p"
)
...
// See https://github.com/vipernet-xyz/tm/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/vipernet-xyz/tm/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/vipernet-xyz/tm/issues/3531
