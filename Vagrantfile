...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd go/src/github.com/vipernet-xyz/tm' >> /home/vagrant/.bash_profile

    mkdir -p /home/vagrant/go/bin
    mkdir -p /home/vagrant/go/src/github.com/tendermint
    ln -s /vagrant /home/vagrant/go/src/github.com/vipernet-xyz/tm
    ...
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/vipernet-xyz/tm && make tools'
  SHELL
end
