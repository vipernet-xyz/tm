...
`import "github.com/vipernet-xyz/tm/crypto"`

For any specific algorithm, use its specific module e.g.
`import "github.com/vipernet-xyz/tm/crypto/ed25519"`

## Binary encoding

For Binary encoding, please refer to the [Tendermint encoding specification](https://github.com/vipernet-xyz/tm/blob/v0.34.x/spec/core/encoding.md).

## JSON Encoding

JSON encoding is done using tendermint's internal json encoder. For more information on JSON encoding, please refer to [Tendermint JSON encoding](https://github.com/vipernet-xyz/tm/blob/ccc990498df70f5a3df06d22476c9bb83812cbe3/libs/json/doc.go)
